...
import { EmbedBuilder, ButtonBuilder, ActionRowBuilder, ButtonStyle, ChatInputCommandInteraction } from 'discord.js';
...
const command: Command = {
    ...
    async execute(interaction: ChatInputCommandInteraction) {
        if (interaction.options.getSubcommand() === 'curseforge') {
            ...
            const row = new ActionRowBuilder<ButtonBuilder>().addComponents(trackButton, moreResultsButton, viewButton);
